defmodule MyGrocyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MyGrocyWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MyGrocyWeb.Gettext, "errors", msg, opts)
    # end
